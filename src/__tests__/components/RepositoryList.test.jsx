...
describe('RepositoryList', () => {
    describe('RepositoryListContainer', () => {
        it('renders repository information correctly', () => {
            ...
            // First repo
            expect(within(firstRepositoryItem).getByTestId('title')).toHaveTextContent('jaredpalmer/formik');
            ...
            // // Second repo
            expect(within(secondRepositoryItem).getByTestId('title')).toHaveTextContent('async-library/react-async');
